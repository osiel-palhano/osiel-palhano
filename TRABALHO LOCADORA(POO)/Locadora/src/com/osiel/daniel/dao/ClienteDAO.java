...
public class ClienteDAO implements DAO<Cliente> {
	...
	public Cliente get(Long id) {
		...
		try {
			...
			while (rset.next()) {
				...
				cliente.setEmail(rset.getString("e_mail"));
	...
	public int save(Cliente cliente) {
		...
		String sql = "insert into cliente (nome, telefone, endereco, e_mail)" + " values (?, ?, ?, ?)";
	...
	public boolean update(Cliente cliente, String[] params) {
		...
		String sql = "update  cliente set nome = ?, telefone = ?, endereco = ?, e_mail = ? where id = ?";

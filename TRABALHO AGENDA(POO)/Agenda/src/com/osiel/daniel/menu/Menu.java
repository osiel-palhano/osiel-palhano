package com.osiel.daniel.menu;

import com.osiel.daniel.controller.MenuController;
...
public class Menu extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			// carregando o loader
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/osiel/daniel/view/Menu.fxml"));
			...
			// atribuindo evento para fecher a janela

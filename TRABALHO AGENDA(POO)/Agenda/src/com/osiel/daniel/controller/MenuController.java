...
public class MenuController implements Initializable {
	...
	@FXML
	void onClickMnoContato(ActionEvent event) {
		try {
			// carregando o loader
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/osiel/daniel/view/ContatoLista.fxml"));
			...
			this.getStage().setScene(contatoListaLayout);
			this.getStage().setTitle("Cadastro de Contato");
